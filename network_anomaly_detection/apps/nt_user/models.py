...
class UserProfile(AbstractUser):
    ...
    email = models.EmailField(null=True, blank=True, max_length=11)
...
class UserFeedbackMessage(BaseModel):
    ...
    topic = models.CharField(max_length=100, default="", verbose_name="主题")
    message = models.TextField(default="", verbose_name="反馈内容", help_text="反馈内容")
